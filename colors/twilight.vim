...
" Last Updated: Mon Jul 22 19:39:03 2024
...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'twilight_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
hi MatchParen guifg=#1576a3 guibg=#000a15 gui=bold cterm=bold
hi CursorLineNr guifg=#ffffff guibg=#00172e gui=bold cterm=bold
hi LineNr guifg=#0057ad guibg=#00172e gui=NONE cterm=NONE
hi VertSplit guifg=#0057ad guibg=#000a15 gui=NONE cterm=NONE
...
hi MatchParen ctermfg=31 ctermbg=232 cterm=bold
hi CursorLineNr ctermfg=231 ctermbg=233 cterm=bold
hi LineNr ctermfg=25 ctermbg=233 cterm=NONE
hi VertSplit ctermfg=25 ctermbg=232 cterm=NONE
